            ...
            {/* Custom grid layout for desktop, vertical stack for mobile */}
            {
                isMobile ? (
                    ...
                    <>
                        ...
                        <div className="relative z-30 max-w-6xl mx-auto mb-32 mt-12">
                        ...
                        <CircularTextLogo className="bottom-6 right-0 translate-x-1/3 translate-y-1/3" zIndex={30} reverse={true} />
                    </>
                )}
        </div>
    );
